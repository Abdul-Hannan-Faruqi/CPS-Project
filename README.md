...
11. Open [3D POINTS](https://github.com/Abdul-Hannan-Faruqi/CPS-Project/tree/main/3-D%20Simulation), which consists of test case trace with `prmcalc.m` concatenated output for this test case.
